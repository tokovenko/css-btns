...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-mandala-editor></app-mandala-editor>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modules__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./modules */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _modules__WEBPACK_IMPORTED_MODULE_4__["MandalaModule"]],
      providers: [],
  ...
  function srcAppModulesMandalaComponentsMandalaEditorMandalaEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var paper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! paper */
    "./node_modules/paper/dist/paper-full.js");
    /* harmony import */


    var paper__WEBPACK_IMPORTED_MODULE_4___default =
    /*#__PURE__*/
    __webpack_require__.n(paper__WEBPACK_IMPORTED_MODULE_4__);
    ...
    /*#__PURE__*/
    function () {
      function MandalaEditorComponent() {
      ...
      _createClass(MandalaEditorComponent, [{
        ...
        value: function ngOnInit() {
          var canvas = document.getElementById('canvas-zones');
          canvas.width = 500;
          canvas.height = 500;
        ...
        key: "initDrawCanvas3",
        value: function initDrawCanvas3() {
          var _this = this;
          ...
          var centerPoint = new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](250, 250);
          var pan = new Hammer.Pan({
            threshold: 10
          });
          var mc = new Hammer.Manager(canvas);
          mc.add([pan]);
          var pan$ = rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
          ...
          mc.on('panstart', function (event) {
            ...
            _this.startPosition = new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](origX, origY);

            var vector = _this.startPosition.subtract(centerPoint);

            var angle = Math.atan2(origY - 250, origX - 250);
            var degrees = 180 * angle / Math.PI;
            var deg = -(360 + Math.round(degrees)) % 360;
            var r = Math.sqrt(Math.pow(250 - origX, 2) + Math.pow(250 - origY, 2)); // debugger;

            console.log('startPosition: ', _this.startPosition);
            console.log('vector: ', vector);
            console.log('vector-angle: ', vector.angle);
            var step = 360 / _this.zones;

            for (var i = 0; i < _this.zones; i++) {
              var radians = (i * step + deg) / 180 * Math.PI;
              var endX = 250 + r * Math.cos(radians);
              var endY = 250 - r * Math.sin(radians);
              vector.angle = vector.angle + i * step;
              var p = centerPoint.clone();
              var p2 = p.add(vector);
              console.log('vector-angle: ', p2.x, p2.y);
              console.log('endX: ', endX, endY); // const path = new paper.Path();
              ...
              var path2 = new paper__WEBPACK_IMPORTED_MODULE_4__["Path"]();
              path2.strokeColor = new paper__WEBPACK_IMPORTED_MODULE_4__["Color"]('red');
              path2.strokeWidth = 4;
              var start2 = new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](250 + vector.x, 250 + vector.y);
              path2.moveTo(start2); // path2.add(new paper.Point(250 + vector.x + 1, 250 - vector.y + 1));

              _this.paths.push(path2);
            }
          });
          mc.on('panend', function (e) {
            for (var i = 0; i < _this.zones; i++) {
              _this.paths[i].simplify();

              _this.paths[i].smooth();
            }

            isDown = false;
          });
          pan$.subscribe(function (event) {
            if (isDown) {
              var step = 360 / _this.zones;
              var angle = Math.atan2(event.center.y - 250, event.center.x - 250);
              var degrees = 180 * angle / Math.PI;
              var deg = -(360 + degrees) % 360;
              var r = Math.sqrt(Math.pow(250 - event.center.x, 2) + Math.pow(250 - event.center.y, 2));

              for (var i = 0; i < _this.zones; i++) {
                var radians = (i * step + deg) / 180 * Math.PI;
                var x = 250 + r * Math.cos(radians);
                var y = 250 - r * Math.sin(radians);

                _this.paths[i].add(new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](x, y)); // this.paths[i].smooth();
        ...
        key: "initDrawCanvas2",
        value: function initDrawCanvas2() {
          var _this2 = this;
          ...
          var origY;
          var canvas = document.getElementById('canvas-draw');
          paper__WEBPACK_IMPORTED_MODULE_4__["setup"](canvas); // path.lineTo(start.add([ 200, -50 ]));
          // paper.view.draw();

          var tool = new paper__WEBPACK_IMPORTED_MODULE_4__["Tool"]();
          ...
          tool.onMouseDown = function (event) {
            ...
            origX = event.point.x;
            origY = event.point.y;
            _this2.startPosition = {
              origX: origX,
              origY: origY
            };
            var step = 360 / _this2.zones;
            var angle = Math.atan2(origY - 250, origX - 250);
            var degrees = 180 * angle / Math.PI;
            var deg = -(360 + Math.round(degrees)) % 360;
            var r = Math.sqrt(Math.pow(250 - origX, 2) + Math.pow(250 - origY, 2));

            for (var i = 0; i < _this2.zones; i++) {
              var radians = (i * step + deg) / 180 * Math.PI;
              var endX = 250 + r * Math.cos(radians);
              var endY = 250 - r * Math.sin(radians);
              console.log('endX, endY: ', endX, endY);
              var path = new paper__WEBPACK_IMPORTED_MODULE_4__["Path"]();
              path.strokeColor = new paper__WEBPACK_IMPORTED_MODULE_4__["Color"]('#000000');
              path.strokeWidth = 4;
              var start = new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](endX, endY);
              path.moveTo(start);
          ...
          tool.onMouseDrag = function (event) {
            if (isDown) {
              var step = 360 / _this2.zones;
              var angle = Math.atan2(event.point.y - 250, event.point.x - 250);
              var degrees = 180 * angle / Math.PI;
              var deg = -(360 + degrees) % 360;
              var r = Math.sqrt(Math.pow(250 - event.point.x, 2) + Math.pow(250 - event.point.y, 2));
              ...
              for (var i = 0; i < _this2.zones; i++) {
                ...
                _this2.paths[i].add(new paper__WEBPACK_IMPORTED_MODULE_4__["Point"](x, y));
              }
            }
          };
          ...
          tool.onMouseUp = function (e) {
            for (var i = 0; i < _this2.zones; i++) {
              _this2.paths[i].simplify();

              _this2.paths[i].smooth();
            }
        ...
        key: "drawAngledLine",
        value: function drawAngledLine(x, y, length, angle) {
        ...
        value: function redrawZones() {
          ...
          if (this.zones > 1) {
            var step = 360 / this.zones;

            for (var i = 0; i < this.zones; i++) {
        ...
        value: function toSVG() {
          ...
          var svgString = paper__WEBPACK_IMPORTED_MODULE_4__["project"].exportSVG({
            asString: true
          });
  ...
  function srcAppModulesMandalaMandalaModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var fabric__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! fabric */
    "./node_modules/fabric/dist/fabric.js");
    /* harmony import */


    var fabric__WEBPACK_IMPORTED_MODULE_5___default =
    /*#__PURE__*/
    __webpack_require__.n(fabric__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    MandalaModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_components__WEBPACK_IMPORTED_MODULE_4__["MandalaEditorComponent"]],
      ...
      exports: [_components__WEBPACK_IMPORTED_MODULE_4__["MandalaEditorComponent"]],
      providers: []
    })], MandalaModule);
    /***/
  },
